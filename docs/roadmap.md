...
- [ ] Decide MPPT vs. static series-matching as the long-term charging
      architecture (informed by Phase 1 results)
- [ ] Coulomb-counting SOC implementation using existing ACS723 sensors
      (replace/augment voltage-lookup SOC)
